...
if ( ! class_exists( 'Theme_Welcome_Notice' ) ) {
	/**
	 * Class - Theme Notice.
	 *
	...
	class Theme_Welcome_Notice {
		...
		public function enqueue_admin_assets() {
			...
			wp_enqueue_script(
				'theme-notice-script',
				get_theme_file_uri() . '/theme-notice/theme-notice.js',
				array( 'jquery' ),
				null, // Update version here.
				true
			);
			...
			wp_enqueue_style(
				'theme-notice-style',
				get_theme_file_uri() . '/theme-notice/theme-notice.css',
				array(),
				null, // Update version here.
				'all'
			);
				...
				<div class="theme-notice__content">
						...
						<div class="theme-notice__head">
							...
							<h2 class="theme-notice__heading">
								...
								printf(
									...
									esc_html__( 'Welcome to %s', 'text-domain' ),
							...
							<p class="theme-notice__description">
								...
								printf(
									...
									esc_html__( 'Thank you for choosing %1$s! To get started with %1$s and import starter templates, install Themebeez Toolkit plugin by clicking on the button below! We hope you enjoy using %1$s.', 'text-domain' ),
									esc_html( $this->theme_name )
								);
								?>
							</p>
							...
							<p>
								<button id="get-started-btn" class="theme-notice__button button button-primary">
									<span class="button-text">
										<?php echo esc_html__( 'Get Started', 'text-domain' ); ?>
									</span>
					...
					<div class="theme-notice__image">
						<img
							...
							alt="<?php echo esc_attr__( 'Notice Image', 'text-domain' ); ?>"
						>
					</div>
				</div>
			</div>
